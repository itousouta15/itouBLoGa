...
私は**台湾の高校生**で、**C++**、**ウェブ開発**、**サイバーセキュリティ**に情熱を持っています。テックコミュニティにも積極的に関わり、コード、セキュリティ、創造性の交差点を常に探っています。
...
- **Scrapyard Taiwan Hackathon** — 9位
- **AIS3 Pre-exam 2025** — 67位
- **Taipei City Microservices Hackathon** — 予選通過
- **11401 FhCTF** — 1位
...
- **逢甲大学** — スマート電子技術 - スマートチップとセンサー応用
- **逢甲大学** — 接続されていれば誰でも簡単にAI制御・設計ができる
- **AIS3 2025** — ソフトウェア、ウェブ、ToIセキュリティコース
- **SCAICT 2025** — 「情報の壁を超える」コース
- **AIS3 Club 2025**
- **Faust Game Jam 2025**
- **DayDream** — 全国青少年ゲーム制作マラソン
- **2025 台湾医療技術展**
- **SITCON 2025**
...
### リーダーシップ
- **第5期 SCAICT** — 会長
- **SCIST x SCAICT 2026 Winter Camp** — 共同責任者
- **第2期 DLHIT** — キャプテン
- **大里高C# & Unityゲームデザインキャンプ** — 代表

### コミュニティ活動
- **SCIST x SCAICT 2026 Winter Camp** — 編集チームリーダー / IT部門
- **第3回 THJCC** — ネットワーク管理
- **第2回 SCINT** — アート・デザイン
- **2026 TWNOG** — デザイン部門
- **2026 g0v Summit** — 会場運営
...
- ブログ: [GitHub Pages](https://blog.itousouta.me)
